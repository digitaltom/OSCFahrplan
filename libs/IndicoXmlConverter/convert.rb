...
# Creating header
schedule_conference = schedule_doc.root << XML::Node.new( "conference" )
...
schedule_conference << XML::Node.new("release", Time.now.to_s )
schedule_conference << XML::Node.new("day_change", "00:00" )
schedule_conference << XML::Node.new("timeslot_duration", "00:15" )
...
dates.each_with_index do |date, i| 
  ...
  roomnames.each do |roomname|
    ...
    talks.each do |talk|
      ...
      persons = event << XML::Node.new("persons")
